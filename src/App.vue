<template>
    <main id="App"  :class="'table-step-'+step">
        <header>
            <button v-if="step >= 1" @click="decrementStep()">Previous Step</button>
            <button v-if="step <= 6" @click="incrementStep()">Next Step</button>
        ...
        <section> 
            ...
            <table >
                ...
                <tr class="step-1">
                    <td class="line-description">Step 1</td>
                    <td></td>
                    <td>500</td>
                </tr>
                <tr class="step-2">
                    <td class="line-description">Step 2</td>
                    <td></td>
                    <td>600</td>
                </tr>
                <tr class="step-5">
                    <td class="line-description">Step 5</td>
                    <td>450</td>
                    <td></td>
                </tr>
        ...
        <section>
            ...
            <table> <!-- Head -->
                ...
                <tr class="step-5">
                    <td class="line-description">[5] 10 units</td>
                    <td></td>
                    <td>450</td>
                </tr>
                <tr class="header-row">
                ...
                <tr class="step-6">
                    <td class="line-description">[6] 10 units</td>
                    <td>250 </td>
                    <td></td>
                </tr>
